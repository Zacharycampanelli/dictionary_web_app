  ...
  return (
    <div className="relative mt-6">
      ...
      <input
        ...
        className="bg-lightestGray border-none text-blackGray font-bold text-base rounded-2xl block w-full p-3.5 md:text-xl  md:pl-6 dark:bg-lighterBlack  dark:text-white"
      />{' '}
    </div>
  );
};
